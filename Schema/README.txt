...
*** NOTE: The script will create the Excel file in the same folder as the script.

*** NOTE: All tables except the ecatalogue table are shared tables, so fields appearing in the resulting Excel file will include custom fields from other implementations.
